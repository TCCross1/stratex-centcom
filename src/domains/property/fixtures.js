...
export const properties = [
  ...
  },
  {
    ...
    propertyType: "Single Family Detached",
    identity: { addressLine1: "62 Harrodsburg Rd", city: "Versailles", region: "KY", postalCode: "40383", yearBuilt: 1962, squareFeet: 2240, parcelId: "08-11-072.00" },
  ...
  {
    stratexPropertyId: "SXP-004201", displayId: "STX-KY-LEX-00002001",
    propertyType: "Single Family Detached",
    identity: { addressLine1: "214 Idle Hour Dr", city: "Lexington", region: "KY", postalCode: "40502", lat: 38.0318, lng: -84.4904, yearBuilt: 1974, squareFeet: 2280, parcelId: "41-16-214.00" },
    createdAt: iso("2026-08-28"), updatedAt: ago(40), healthScore: 71,
    status: "ATTENTION", currentStage: "scheduled", blocker: null,
    latestScanAt: null, latestMissionId: "M-2026-0830-040",
    missionCount: 1, evidenceCount: 0, findingCount: 0, openAlerts: 1,
    twinVersion: "—", passportRevision: "r01",
    passportState: "PENDING", cortexState: "IDLE", coreState: "IDLE",
    proState: "NONE", habitatState: "NOT_CONNECTED",
  ...
  {
    stratexPropertyId: "SXP-004202", displayId: "STX-KY-LEX-00002002",
    propertyType: "Single Family Detached",
    identity: { addressLine1: "447 Tates Creek Rd", city: "Lexington", region: "KY", postalCode: "40517", lat: 37.9976, lng: -84.4948, yearBuilt: 1989, squareFeet: 1860, parcelId: "41-21-447.00" },
    createdAt: iso("2026-08-28"), updatedAt: ago(38), healthScore: 64,
    status: "ATTENTION", currentStage: "scheduled", blocker: null,
    latestScanAt: null, latestMissionId: "M-2026-0830-041",
    missionCount: 1, evidenceCount: 0, findingCount: 0, openAlerts: 1,
    twinVersion: "—", passportRevision: "r01",
    passportState: "PENDING", cortexState: "IDLE", coreState: "IDLE",
    proState: "NONE", habitatState: "NOT_CONNECTED",
  ...
  {
    stratexPropertyId: "SXP-004203", displayId: "STX-KY-LEX-00002003",
    propertyType: "Single Family Detached",
    identity: { addressLine1: "890 Alumni Dr", city: "Lexington", region: "KY", postalCode: "40503", lat: 38.0191, lng: -84.5074, yearBuilt: 2008, squareFeet: 2740, parcelId: "41-12-890.00" },
    createdAt: iso("2026-08-29"), updatedAt: ago(22), healthScore: 82,
    status: "ACTIVE", currentStage: "scheduled", blocker: null,
    latestScanAt: null, latestMissionId: "M-2026-0830-042",
    missionCount: 1, evidenceCount: 0, findingCount: 0, openAlerts: 0,
    twinVersion: "—", passportRevision: "r01",
    passportState: "PENDING", cortexState: "IDLE", coreState: "IDLE",
    proState: "NONE", habitatState: "NOT_CONNECTED",
  },
  {
    stratexPropertyId: "SXP-004204", displayId: "STX-KY-LEX-00002004",
    propertyType: "Commercial",
    identity: { addressLine1: "55 Cheapside", city: "Lexington", region: "KY", postalCode: "40507", lat: 38.0474, lng: -84.4967, yearBuilt: 1922, squareFeet: 18400, parcelId: "41-01-055.00" },
    createdAt: iso("2026-08-29"), updatedAt: ago(18), healthScore: 69,
    status: "ATTENTION", currentStage: "scheduled", blocker: null,
    latestScanAt: null, latestMissionId: "M-2026-0830-043",
    missionCount: 1, evidenceCount: 0, findingCount: 0, openAlerts: 1,
    twinVersion: "—", passportRevision: "r01",
    passportState: "PENDING", cortexState: "IDLE", coreState: "IDLE",
    proState: "NONE", habitatState: "NOT_CONNECTED",
  ...
  {
    stratexPropertyId: "SXP-004205", displayId: "STX-KY-LEX-00002005",
    propertyType: "Single Family Detached",
    identity: { addressLine1: "3101 Todds Rd", city: "Lexington", region: "KY", postalCode: "40509", lat: 38.0058, lng: -84.4041, yearBuilt: 2016, squareFeet: 3410, parcelId: "41-33-101.00" },
    createdAt: iso("2026-08-29"), updatedAt: ago(16), healthScore: 90,
    status: "ACTIVE", currentStage: "scheduled", blocker: null,
    latestScanAt: null, latestMissionId: "M-2026-0830-044",
    missionCount: 1, evidenceCount: 0, findingCount: 0, openAlerts: 0,
    twinVersion: "—", passportRevision: "r01",
    passportState: "PENDING", cortexState: "IDLE", coreState: "IDLE",
    proState: "NONE", habitatState: "NOT_CONNECTED",
