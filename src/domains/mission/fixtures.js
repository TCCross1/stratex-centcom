...
export const missions = [
  ...
  // 2b — same Lexington day as 0830-020, second Board chip on 2026-08-30
  { ...base, id: "M-2026-0830-022", propertyId: "SXP-004193",
    originType: "STRATEX_INTERNAL", missionType: "Envelope Recheck",
    assessmentObjective: "EXTERIOR", requestedPackage: "DAYSCAN",
    requestedServices: ["RGB_MAPPING"],
    missionState: "SCHEDULED", authorizationState: "NOT_REQUIRED",
    jobNumber: "JOB-4193",
    requestedDate: iso("2026-08-30"), scheduledStart: iso("2026-08-30T10:15:00"), scheduledEnd: iso("2026-08-30T11:30:00"),
    operatorId: "OP-01", aircraftId: "AC-M4TD-01", sensorPackageId: "SP-RGB",
    createdAt: ago(390), updatedAt: ago(110) },

  { ...base, id: "M-2026-0830-040", propertyId: "SXP-004201",
    originType: "HOMEOWNER", requestingPartyType: "PARTY", requestingPartyRef: "P-8801",
    missionType: "Storm Leak Check", assessmentObjective: "LEAK_MOISTURE",
    requestedPackage: "DAYSCAN", requestedServices: ["RGB_MAPPING", "ROOF_GEOMETRY"],
    jobNumber: "JOB-4201",
    knownIssues: [{ id: "KI-D1", issue: "Ceiling stain after last night's storm", reportedBy: "HOMEOWNER", location: "Master bedroom", severity: null, notes: "Demo circumstance — not a verified finding." }],
    specialInstructions: "Park on Idle Hour. Dog in backyard until 11:00.",
    missionState: "SCHEDULED", authorizationState: "NOT_REQUIRED",
    requestedDate: iso("2026-08-30"), scheduledStart: iso("2026-08-30T08:15:00"), scheduledEnd: iso("2026-08-30T09:30:00"),
    operatorId: "OP-01", aircraftId: "AC-M4TD-01", sensorPackageId: "SP-RGB",
    createdAt: ago(80), updatedAt: ago(40) },

  { ...base, id: "M-2026-0830-041", propertyId: "SXP-004202",
    originType: "PROFESSIONAL", requestingPartyType: "ORGANIZATION", requestingPartyRef: "ORG-BLUEGRASS",
    missionType: "Insurance Hail Survey", assessmentObjective: "STORM_DAMAGE",
    requestedPackage: "DAYSCAN", requestedServices: ["RGB_MAPPING", "ROOF_GEOMETRY", "DAMAGE_ASSESSMENT"],
    jobNumber: "JOB-4202",
    knownIssues: [{ id: "KI-D2", issue: "Carrier reports hail on Tates Creek corridor", reportedBy: "PROFESSIONAL", location: "South roof plane", severity: null, notes: "Demo circumstance." }],
    specialInstructions: "Adjuster on site at 09:45. Do not fly over school drop-off.",
    missionState: "SCHEDULED", authorizationState: "NOT_REQUIRED",
    requestedDate: iso("2026-08-30"), scheduledStart: iso("2026-08-30T09:45:00"), scheduledEnd: iso("2026-08-30T11:00:00"),
    operatorId: "OP-02", aircraftId: "AC-M4TD-02", sensorPackageId: "SP-RGB-LID",
    createdAt: ago(78), updatedAt: ago(38) },

  { ...base, id: "M-2026-0830-042", propertyId: "SXP-004203",
    originType: "STRATEX_INTERNAL", missionType: "HVAC Envelope Recheck",
    assessmentObjective: "HVAC_ENVELOPE", requestedPackage: "THERMALSCAN",
    requestedServices: ["THERMAL_CAPTURE", "EXTERIOR_CAPTURE"],
    jobNumber: "JOB-4203",
    knownIssues: [{ id: "KI-D3", issue: "Homeowner reports uneven cooling upstairs", reportedBy: "HOMEOWNER", location: "Second floor west", severity: null, notes: "Demo circumstance." }],
    specialInstructions: "UK game day traffic — keep window tight.",
    missionState: "SCHEDULED", authorizationState: "NOT_REQUIRED",
    requestedDate: iso("2026-08-30"), scheduledStart: iso("2026-08-30T11:30:00"), scheduledEnd: iso("2026-08-30T12:30:00"),
    operatorId: "OP-01", aircraftId: "AC-M4TD-01", sensorPackageId: "SP-RGB-IR",
    createdAt: ago(70), updatedAt: ago(22) },

  { ...base, id: "M-2026-0830-043", propertyId: "SXP-004204",
    originType: "PROFESSIONAL", requestingPartyType: "ORGANIZATION", requestingPartyRef: "ORG-LEX-FACILITIES",
    missionType: "Downtown Roof Condition", assessmentObjective: "COMMERCIAL_ROOF",
    requestedPackage: "COMPLETE_PROPERTY_INTELLIGENCE",
    requestedServices: ["RGB_MAPPING", "ROOF_GEOMETRY", "MEASUREMENTS"],
    jobNumber: "JOB-4204",
    knownIssues: [{ id: "KI-D4", issue: "Ponding reported at northwest scupper", reportedBy: "PROFESSIONAL", location: "NW roof", severity: null, notes: "Demo circumstance." }],
    specialInstructions: "NOTAM check required. Cheapside lunch crowd — stay over the roof.",
    missionState: "SCHEDULED", authorizationState: "NOT_REQUIRED",
    requestedDate: iso("2026-08-30"), scheduledStart: iso("2026-08-30T14:00:00"), scheduledEnd: iso("2026-08-30T15:20:00"),
    operatorId: "OP-02", aircraftId: "AC-DOCK-03", sensorPackageId: "SP-RGB-LID",
    createdAt: ago(66), updatedAt: ago(18) },

  { ...base, id: "M-2026-0830-044", propertyId: "SXP-004205",
    originType: "HOMEOWNER", requestingPartyType: "PARTY", requestingPartyRef: "P-8805",
    missionType: "New Build Closeout Scan", assessmentObjective: "POST_PROJECT",
    requestedPackage: "PROJECT_VERIFICATION",
    requestedServices: ["RGB_MAPPING", "EXTERIOR_CAPTURE", "PROJECT_VERIFICATION"],
    jobNumber: "JOB-4205",
    knownIssues: [{ id: "KI-D5", issue: "Builder punch list: flashing at chimney", reportedBy: "HOMEOWNER", location: "Rear chimney", severity: null, notes: "Demo circumstance." }],
    specialInstructions: "Gated community — use code 2140. HOA drone notice already posted.",
    missionState: "SCHEDULED", authorizationState: "NOT_REQUIRED",
    requestedDate: iso("2026-08-30"), scheduledStart: iso("2026-08-30T16:00:00"), scheduledEnd: iso("2026-08-30T17:15:00"),
    operatorId: "OP-01", aircraftId: "AC-M4TD-01", sensorPackageId: "SP-RGB",
    createdAt: ago(60), updatedAt: ago(16) },
